...
public class UserDAO {
	...
	public User createUser(User u) {
		...
		String sql = "insert into bankingapp.users values (default, ?, ?, ?, ?) returning *";
	...
	public List<User> getAllUsers() {
		...
		String sql = "select * from bankingapp.users";
	...
	public User getUserById(int id) {
		...
		String sql = "select * from bankingapp.users where id = ?"; // this question mark symbolizes and IN parameter for our statement
	...
	public void updateUser(User uChange) {
		...
		String sql = "update bankingapp.users set first_name = ?, last_name = ?, username = ?, pass = ? where id = ?";
	...
	public void deleteUser(int id) {
		String sql = "delete from bankingapp.users where id = ?";
	...
	public User updateUserPassword(int id, String password) {
		...
		String sql = "update bankingapp.users set pass = ? where id = ? returning *";
